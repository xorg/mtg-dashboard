<template>
  ...
  <div class="grid grid-cols-1 px-4 gap-4 mt-8 sm:grid-cols-3 sm:px-8">
    <div v-for="collection in collections" :key="collections.name">
      <div class="px-4 py-2 bg-white border rounded-md overflow-hidden shadow">
        ...
        <apexchart type="area" :height="300" :options="pageViewOptions" :series="collection.value_history"></apexchart>
      </div>
    </div>
    <!-- 
    <div class="px-4 py-2 bg-white border rounded-md overflow-hidden shadow">
